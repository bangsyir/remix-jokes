...
function validateUsername(username: string) {
  if(typeof username !== "string" || username.length < 3) {
    return `Username mus be at least 3 characters long`
  }
}
...
// response badrequest from server
      ...
      <div className="content" data-light="">
        ...
        >
          ...
          <fieldset>
            ...
            <label>
              <input type="radio" name="loginType" value="register" defaultChecked={
          ...
          <div>
            ...
            />
            {actionData?.fieldErrors?.username ? (
              <p className="form-validation-error" role="alert" id="username-error">{actionData?.fieldErrors?.username}</p>
            ) : null}
          </div>
          <div>
